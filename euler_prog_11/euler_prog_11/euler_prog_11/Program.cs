...
namespace euler_prog_11
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine("Max Product of 4 numbers horizontally is " + maxProduct.ToString());
      ...
      Console.WriteLine("Max Product of 4 numbers diagonally right is " + maxProduct.ToString());
      ...
      Console.WriteLine("Max Product of 4 numbers diagonally left is " + maxProduct.ToString());
